...
with open(clean_path(join(dirname(__file__), "html1.html")), "w", encoding="utf-8") as file:
    file.write(html1)

with open(clean_path(join(dirname(__file__), "html2.html")), "w", encoding="utf-8") as file:
    file.write(html2)
