...
if __name__ == "__main__":
    # update_footer_table_widths(r"D:\Testing\02_Word Tests\TV_RER09.docx", back_up=True, debug=True)
    # read_word_footers(r"D:\Testing\02_Word Tests\TV_RER09.docx", back_up=False, debug=True)
    # print(get_regex_string(r"D:\Testing\02_Word Tests\TV_RER09.docx", r"(TV_RER09)(.*?)($)", back_up=False, debug=False))
    
    # zip_word_folder(r"D:\Testing\02_Word Tests\TV_RER09")


    # docx_footer_replace(r"D:\Testing\02_Word Tests\TV_RER09.docx", "Liebherr-Elektronik GmbH", "Liebherr-Electronics and Drives GmbH", back_up=True, debug=True)
    #docx_footer_replace(r"D:\Testing\02_Word Tests\TV_DAD06.docx", "Liebherr-Elektronik GmbH", "Liebherr-Electronics and Drives GmbH", back_up=True, debug=True)

    # adjust_column_widths(r"D:\Testing\02_Word Tests\TV_RER09.docx", where="footer", col=3, difference=1.1, back_up=False, debug=True)
    # adjust_column_widths(r"D:\Testing\02_Word Tests\TV_DAD06.docx", where="footer", col=3, difference=1.1, back_up=False, debug=True)
    # print(get_footer_type(r"D:\Testing\02_Word Tests\TV_DAD06.docx"))
    # print(get_footer_type(r"D:\Testing\02_Word Tests\TV_RER09.docx"))
    # print(get_table_column_widths(r"D:\Testing\02_Word Tests\TV_DAD06.docx", "footer"))
    # print(get_table_column_widths(r"D:\Testing\02_Word Tests\TV_RER09.docx", "footer"))
    # print(get_table_column_widths(r"D:\Testing\02_Word Tests\TV_RER09_modified.docx", "footer"))

    # docx_content_replace(
    #     r"D:\Liebherr Automation\TV_DAD06.docx",
    #     "Ref",
    #     "Ref2",
    #     back_up=True,
    #     debug=True
    ...
    #     r"D:\Liebherr Automation\TV_DAD06.docx",
    #     "image1.png",
    #     r"D:\Liebherr Automation\image1.png",
    #     back_up=True,
    #     debug=True
    # )
    # word2pdf(r"D:\Excel Tests")
    replace_copyright(r"C:\Users\bakalarz\Desktop\LED-Project\docs\TV_MPH_01.docx")
